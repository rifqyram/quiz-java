...
public class Jeruk {
    ...
    private void initProduct() {
        ...
        product1.put("id", "1");
        product1.put("name", "Jeruk Nipis");
        product1.put("price", 5000);

        Map<String, Object> product2 = new HashMap<>();
        product2.put("id", "2");
        product2.put("name", "Jeruk Manis");
        product2.put("price", 10000);

        Map<String, Object> product3 = new HashMap<>();
        product3.put("id", "3");
        product3.put("name", "Jeruk Bali");
        product3.put("price", 50000);
